...
$(document).keydown(function(e) {
    ...
    var now = Date.now();
    // Only trigger event if a sentence has been selected, add .4 second cooldown
...
function renderMappings(sentence_id) {
    ...
    for (var i = 0; i < sentence.mappings.length; i++) {
        ...
        $removeButton = $(`<button type="button" class="btn btn-sm btn-danger"><em class="fas fa-minus-circle"></em>`);
